...
public class BackendDriver {
	...
	static getNextIndex nextDex = new getNextIndex();
	...
	public static void updateIndex(String tableName){
		...
		public static int getNextIndex(String tableName){
			switch (tableName){
			case("prompts"):return nextDex.getIndex(1); 
			case("keywords"):return nextDex.getIndex(2);
			case("users"): return nextDex.getIndex(3);
			case("storage"):return nextDex.getIndex(4);
			}	
